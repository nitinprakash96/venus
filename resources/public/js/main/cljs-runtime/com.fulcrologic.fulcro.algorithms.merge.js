...
return cljs.core.vec(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__61136_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(ident,p1__61136_SHARP_);
}),old_list));
});
...
var G__61144 = kw__$1;
var G__61144__$1 = (((G__61144 == null))?null:cljs.core.namespace(G__61144));
if((G__61144__$1 == null)){
return null;
} else {
return cljs.core.re_find(/^ui(?:\.|$)/,G__61144__$1);
}
} else {
return null;
}
...
var mock_missing_object = (function (){var G__61202 = cljs.core.PersistentArrayMap.EMPTY;
var G__61203 = com.fulcrologic.fulcro.algorithms.do_not_use.join_value(element__$1);
return (com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2(G__61202,G__61203) : com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.call(null,G__61202,G__61203));
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result__$1,jk,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (item){
var G__61206 = item;
var G__61207 = com.fulcrologic.fulcro.algorithms.do_not_use.join_value(element__$1);
return (com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2(G__61206,G__61207) : com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.call(null,G__61206,G__61207));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result__$1,jk,(function (){var G__61209 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(result__$1,jk);
var G__61210 = com.fulcrologic.fulcro.algorithms.do_not_use.join_value(element__$1);
return (com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2(G__61209,G__61210) : com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.call(null,G__61209,G__61210));
})());
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result__$1,result_key,(function (){var G__61214 = cljs.core.PersistentArrayMap.EMPTY;
var G__61215 = com.fulcrologic.fulcro.algorithms.do_not_use.join_value(element__$1);
return (com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.cljs$core$IFn$_invoke$arity$2(G__61214,G__61215) : com.fulcrologic.fulcro.algorithms.merge.mark_missing_impl.call(null,G__61214,G__61215));
})());
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__61232){
var vec__61233 = p__61232;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61233,(0),null);
...
if((((!(com.fulcrologic.fulcro.algorithms.tempid.tempid_QMARK_(m)))) && (cljs.core.map_QMARK_(m)))){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__61276){
var vec__61277 = p__61276;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61277,(0),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__61299){
var vec__61300 = p__61299;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61300,(0),null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61300,(1),null);
...
var entity = (function (){var G__61330 = com.fulcrologic.fulcro.components.get_ident.cljs$core$IFn$_invoke$arity$2(class$,data);
if((G__61330 == null)){
return null;
} else {
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state,G__61330);
}
})();
...
var G__61446 = com.fulcrologic.fulcro.algorithms.merge.sweep_merge(updated_state,db);
var G__61446__$1 = (cljs.core.truth_(target)?com.fulcrologic.fulcro.algorithms.data_targeting.process_target.cljs$core$IFn$_invoke$arity$3(G__61446,idnt,target):G__61446);
if(cljs.core.not(target)){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__61446__$1,db,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([idnt], 0));
} else {
return G__61446__$1;
}
} else {
...
var map__61468 = cljs.core.group_by((function (p1__61455_SHARP_){
return cljs.core.vector_QMARK_(cljs.core.first(p1__61455_SHARP_));
}),res);
var map__61468__$1 = cljs.core.__destructure_map(map__61468);
var idents = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61468__$1,true);
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61468__$1,false);
...
var source_to_merge = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__61475){
var vec__61476 = p__61475;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61476,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61476,(1),null);
...
var ident_joins = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__61483_SHARP_){
var G__61493 = p1__61483_SHARP_;
if(cljs.core.seq_QMARK_(p1__61483_SHARP_)){
return cljs.core.first(G__61493);
} else {
return G__61493;
}
})),cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__61488_SHARP_){
return ((com.fulcrologic.fulcro.algorithms.do_not_use.join_QMARK_(p1__61488_SHARP_)) && (edn_query_language.core.ident_QMARK_(com.fulcrologic.fulcro.algorithms.do_not_use.join_key(p1__61488_SHARP_))));
}))),query);
var step = (function com$fulcrologic$fulcro$algorithms$merge$merge_idents_$_step(result_tree,p__61537){
var vec__61543 = p__61537;
var ident = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61543,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61543,(1),null);
...
var vec__61578 = com.fulcrologic.fulcro.algorithms.merge.sift_idents(result_tree);
var idts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61578,(0),null);
var result_tree__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61578,(1),null);
...
var com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast__3 = (function (p__61689,visitor,parent_union){
var map__61690 = p__61689;
var map__61690__$1 = cljs.core.__destructure_map(map__61690);
var parent_ast = map__61690__$1;
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61690__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61690__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61690__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61690__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61690__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61690__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
var seq__61696 = cljs.core.seq(children);
var chunk__61697 = null;
var count__61698 = (0);
var i__61699 = (0);
while(true){
if((i__61699 < count__61698)){
var ast = chunk__61697.cljs$core$IIndexed$_nth$arity$2(null,i__61699);
...
var G__61878 = seq__61696;
var G__61879 = chunk__61697;
var G__61880 = count__61698;
var G__61881 = (i__61699 + (1));
seq__61696 = G__61878;
chunk__61697 = G__61879;
count__61698 = G__61880;
i__61699 = G__61881;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__61696);
if(temp__5753__auto__){
var seq__61696__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__61696__$1)){
var c__4638__auto__ = cljs.core.chunk_first(seq__61696__$1);
var G__61883 = cljs.core.chunk_rest(seq__61696__$1);
var G__61884 = c__4638__auto__;
var G__61885 = cljs.core.count(c__4638__auto__);
var G__61886 = (0);
seq__61696 = G__61883;
chunk__61697 = G__61884;
count__61698 = G__61885;
i__61699 = G__61886;
continue;
} else {
var ast = cljs.core.first(seq__61696__$1);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(ast),new cljs.core.Keyword(null,"union","union",2142937499))){
com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast.cljs$core$IFn$_invoke$arity$3(ast,visitor,component);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(ast),new cljs.core.Keyword(null,"union-entry","union-entry",223335750))){
...
var G__61889 = cljs.core.next(seq__61696__$1);
var G__61890 = null;
var G__61891 = (0);
var G__61892 = (0);
seq__61696 = G__61889;
chunk__61697 = G__61890;
count__61698 = G__61891;
i__61699 = G__61892;
continue;
}
} else {
...
com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast = function(p__61689,visitor,parent_union){
switch(arguments.length){
case 2:
return com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast__2.call(this,p__61689,visitor);
case 3:
return com$fulcrologic$fulcro$algorithms$merge$merge_alternate_unions_$_walk_ast__3.call(this,p__61689,visitor,parent_union);
}
...
var map__61739 = com.fulcrologic.fulcro.components.any__GT_app(app__$1);
var map__61739__$1 = cljs.core.__destructure_map(map__61739);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61739__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
...
var len__4818__auto___61905 = arguments.length;
var i__4819__auto___61906 = (0);
while(true){
if((i__4819__auto___61906 < len__4818__auto___61905)){
args__4824__auto__.push((arguments[i__4819__auto___61906]));

var G__61908 = (i__4819__auto___61906 + (1));
i__4819__auto___61906 = G__61908;
continue;
} else {
}
break;
...
var map__61758 = options;
var map__61758__$1 = cljs.core.__destructure_map(map__61758);
var remove_missing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61758__$1,new cljs.core.Keyword(null,"remove-missing?","remove-missing?",-2044119224));
...
var integrate_params = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__61763){
var vec__61764 = p__61763;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61764,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61764,(1),null);
if(cljs.core.truth_((function (){var fexpr__61771 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"replace","replace",-786587770),null,new cljs.core.Keyword(null,"prepend","prepend",342616040),null,new cljs.core.Keyword(null,"append","append",-291298229),null], null), null);
return (fexpr__61771.cljs$core$IFn$_invoke$arity$1 ? fexpr__61771.cljs$core$IFn$_invoke$arity$1(k) : fexpr__61771.call(null,k));
})())){
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.merge.merge_component.cljs$lang$applyTo = (function (seq61747){
var G__61748 = cljs.core.first(seq61747);
var seq61747__$1 = cljs.core.next(seq61747);
var G__61749 = cljs.core.first(seq61747__$1);
var seq61747__$2 = cljs.core.next(seq61747__$1);
var G__61750 = cljs.core.first(seq61747__$2);
var seq61747__$3 = cljs.core.next(seq61747__$2);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61748,G__61749,G__61750,seq61747__$3);
}));
...
var args__4824__auto__ = [];
var len__4818__auto___61919 = arguments.length;
var i__4819__auto___61920 = (0);
while(true){
if((i__4819__auto___61920 < len__4818__auto___61919)){
args__4824__auto__.push((arguments[i__4819__auto___61920]));

var G__61921 = (i__4819__auto___61920 + (1));
i__4819__auto___61920 = G__61921;
continue;
} else {
}
break;
...
var G__61796 = app__$2;
var G__61797 = cljs.core.PersistentArrayMap.EMPTY;
return (render_BANG_.cljs$core$IFn$_invoke$arity$2 ? render_BANG_.cljs$core$IFn$_invoke$arity$2(G__61796,G__61797) : render_BANG_.call(null,G__61796,G__61797));
}
} else {
return null;
}
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.merge.merge_component_BANG_.cljs$lang$applyTo = (function (seq61783){
var G__61784 = cljs.core.first(seq61783);
var seq61783__$1 = cljs.core.next(seq61783);
var G__61785 = cljs.core.first(seq61783__$1);
var seq61783__$2 = cljs.core.next(seq61783__$1);
var G__61786 = cljs.core.first(seq61783__$2);
var seq61783__$3 = cljs.core.next(seq61783__$2);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61784,G__61785,G__61786,seq61783__$3);
}));
