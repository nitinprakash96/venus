...
var no_stacktrace_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55913__$1,new cljs.core.Keyword(null,"no-stacktrace?","no-stacktrace?",1701072694));
var stacktrace_fonts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55913__$1,new cljs.core.Keyword(null,"stacktrace-fonts","stacktrace-fonts",830799382));
var map__55914 = data;
var map__55914__$1 = cljs.core.__destructure_map(map__55914);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55914__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55914__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var msg_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55914__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55914__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55914__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55914__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55914__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55914__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
...
var len__4818__auto___56192 = arguments.length;
var i__4819__auto___56193 = (0);
while(true){
if((i__4819__auto___56193 < len__4818__auto___56192)){
args__4824__auto__.push((arguments[i__4819__auto___56193]));

var G__56195 = (i__4819__auto___56193 + (1));
i__4819__auto___56193 = G__56195;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq55950){
var G__55951 = cljs.core.first(seq55950);
var seq55950__$1 = cljs.core.next(seq55950);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55951,seq55950__$1);
}));
...
return ((function (){var G__56003 = taoensso.timbre.valid_level(x);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__56003) : taoensso.timbre._levels_map.call(null,G__56003));
})() >= (function (){var G__56005 = taoensso.timbre.valid_level(y);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__56005) : taoensso.timbre._levels_map.call(null,G__56005));
})());
});
...
var fexpr__56008 = taoensso.timbre._compile_ns_filter(whitelist,blacklist);
return (fexpr__56008.cljs$core$IFn$_invoke$arity$1 ? fexpr__56008.cljs$core$IFn$_invoke$arity$1(_QMARK_ns) : fexpr__56008.call(null,_QMARK_ns));
}));
/**
...
var vec__56035 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56035,(0),null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__56038 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56038,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__56056 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56056,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(fmt_msg_QMARK_)?taoensso.timbre.vrest(vargs__$1):vargs__$1);
...
var instant_56227 = taoensso.encore.now_dt();
var context_56228 = taoensso.timbre._STAR_context_STAR_;
var vargs_56229 = cljs.core.deref(vargs_);
var vec__56102_56230 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_56229);
var _QMARK_err_56231__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56102_56230,(0),null);
var _QMARK_meta_56232 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56102_56230,(1),null);
var _QMARK_msg_fmt_56234 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56102_56230,(2),null);
var vargs_56235__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56102_56230,(3),null);
var data_56236 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4212__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?err_","?err_",789480858),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891)],[instant_56227,config,vargs_56235__$1,_QMARK_file,(function (){var fexpr__56105 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null);
return (fexpr__56105.cljs$core$IFn$_invoke$arity$1 ? fexpr__56105.cljs$core$IFn$_invoke$arity$1(level) : fexpr__56105.call(null,level));
})(),_QMARK_ns_str,level,_QMARK_err_56231__$1,context_56228,_QMARK_line,(new cljs.core.Delay((function (){
return _QMARK_err_56231__$1;
}),null)),_QMARK_meta_56232,_QMARK_msg_fmt_56234]));
var _QMARK_data_56237 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_56236,new cljs.core.Keyword(null,"middleware","middleware",1462115504).cljs$core$IFn$_invoke$arity$1(config));
var temp__5753__auto___56243 = _QMARK_data_56237;
if(cljs.core.truth_(temp__5753__auto___56243)){
var data_56244__$1 = temp__5753__auto___56243;
var map__56108_56245 = data_56244__$1;
var map__56108_56246__$1 = cljs.core.__destructure_map(map__56108_56245);
var vargs_56247__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56108_56246__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_56248__$2 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_56244__$1,new cljs.core.Keyword(null,"vargs_","vargs_",552132148),(new cljs.core.Delay((function (){
return vargs_56247__$2;
}),null)));
var data_56249__$3 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_56248__$2,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
var G__56109 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__56109)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__56109)){
return taoensso.timbre.str_join(vargs_56247__$2);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__56109)){
if(typeof _QMARK_msg_fmt_56234 === 'string'){
} else {
...
return taoensso.encore.format_STAR_(_QMARK_msg_fmt_56234,vargs_56247__$2);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56109)].join('')));
...
return cljs.core.hash(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [callsite_id,_QMARK_msg_fmt_56234,cljs.core.get.cljs$core$IFn$_invoke$arity$3(_QMARK_meta_56232,new cljs.core.Keyword(null,"hash","hash",-13781596),vargs_56247__$2)], null));
}),null))], 0));
var output_fn1_56250 = taoensso.encore.memoize_(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
return cljs.core.not((function (){var G__56120 = cljs.core.force(new cljs.core.Keyword(null,"hash_","hash_",-827203612).cljs$core$IFn$_invoke$arity$1(data_56249__$3));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__56120) : rl_fn.call(null,G__56120));
})());
}
})();
if(rate_limit_okay_QMARK_){
var map__56123 = appender;
var map__56123__$1 = cljs.core.__destructure_map(map__56123);
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56123__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56123__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
...
return output_fn1_56250;
} else {
return f;
}
})();
var output_ = (new cljs.core.Delay((function (){
return (output_fn.cljs$core$IFn$_invoke$arity$1 ? output_fn.cljs$core$IFn$_invoke$arity$1(data_56249__$3) : output_fn.call(null,data_56249__$3));
}),null));
var data__$4 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(data_56249__$3,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"appender-id","appender-id",-1917983538),id,new cljs.core.Keyword(null,"appender","appender",1267426510),appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),output_fn,new cljs.core.Keyword(null,"output_","output_",-36797880),output_], null));
...
var args__4824__auto__ = [];
var len__4818__auto___56263 = arguments.length;
var i__4819__auto___56264 = (0);
while(true){
if((i__4819__auto___56264 < len__4818__auto___56263)){
args__4824__auto__.push((arguments[i__4819__auto___56264]));

var G__56266 = (i__4819__auto___56264 + (1));
i__4819__auto___56264 = G__56266;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq56176){
var self__4806__auto__ = this;
return self__4806__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56176));
}));
