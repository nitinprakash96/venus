...
var len__4818__auto___56094 = arguments.length;
var i__4819__auto___56095 = (0);
while(true){
if((i__4819__auto___56095 < len__4818__auto___56094)){
args_arr__4839__auto__.push((arguments[i__4819__auto___56095]));

var G__56097 = (i__4819__auto___56095 + (1));
i__4819__auto___56095 = G__56097;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq55995){
var G__55996 = cljs.core.first(seq55995);
var seq55995__$1 = cljs.core.next(seq55995);
var G__55997 = cljs.core.first(seq55995__$1);
var seq55995__$2 = cljs.core.next(seq55995__$1);
var G__55998 = cljs.core.first(seq55995__$2);
var seq55995__$3 = cljs.core.next(seq55995__$2);
var G__55999 = cljs.core.first(seq55995__$3);
var seq55995__$4 = cljs.core.next(seq55995__$3);
var G__56000 = cljs.core.first(seq55995__$4);
var seq55995__$5 = cljs.core.next(seq55995__$4);
var G__56001 = cljs.core.first(seq55995__$5);
var seq55995__$6 = cljs.core.next(seq55995__$5);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55996,G__55997,G__55998,G__55999,G__56000,G__56001,seq55995__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__56030){
var vec__56032 = p__56030;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56032,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56032,(1),null);
