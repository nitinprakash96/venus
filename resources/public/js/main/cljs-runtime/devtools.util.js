...
var len__4818__auto___46057 = arguments.length;
var i__4819__auto___46058 = (0);
while(true){
if((i__4819__auto___46058 < len__4818__auto___46057)){
args__4824__auto__.push((arguments[i__4819__auto___46058]));

var G__46059 = (i__4819__auto___46058 + (1));
i__4819__auto___46058 = G__46059;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__45930_46060 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__45931_46061 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__45932_46062 = true;
var _STAR_print_fn_STAR__temp_val__45933_46063 = (function (x__4750__auto__){
return sb__4749__auto__.append(x__4750__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__45932_46062);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__45933_46063);

try{var _STAR_print_level_STAR__orig_val__45934_46064 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__45935_46065 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__45935_46065);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__45934_46064);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__45931_46061);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__45930_46060);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq45917){
var self__4806__auto__ = this;
return self__4806__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45917));
}));
...
var new_formatters = current_formatters.filter((function (p1__45993_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__45993_SHARP_)));
}));
...
var G__45998_46093 = f;
var target__43219__auto___46094 = G__45998_46093;
if(cljs.core.truth_(target__43219__auto___46094)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45998_46093)].join(''),"\n","target__43219__auto__"].join('')));
}

(target__43219__auto___46094["toString"] = (function (){
...
var G__46002_46095 = "%c%s";
var G__46003_46096 = "color:transparent";
var G__46004_46097 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__46002_46095,G__46003_46096,G__46004_46097) : f.call(null,G__46002_46095,G__46003_46096,G__46004_46097));
...
var args__4824__auto__ = [];
var len__4818__auto___46100 = arguments.length;
var i__4819__auto___46101 = (0);
while(true){
if((i__4819__auto___46101 < len__4818__auto___46100)){
args__4824__auto__.push((arguments[i__4819__auto___46101]));

var G__46102 = (i__4819__auto___46101 + (1));
i__4819__auto___46101 = G__46102;
continue;
} else {
}
break;
...
var vec__46012 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46012,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46012,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__46108__delegate = function (add_fmt,add_args){
...
var G__46108 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__46113__i = 0, G__46113__a = new Array(arguments.length -  1);
while (G__46113__i < G__46113__a.length) {G__46113__a[G__46113__i] = arguments[G__46113__i + 1]; ++G__46113__i;}
  add_args = new cljs.core.IndexedSeq(G__46113__a,0,null);
} 
return G__46108__delegate.call(this,add_fmt,add_args);};
G__46108.cljs$lang$maxFixedArity = 1;
G__46108.cljs$lang$applyTo = (function (arglist__46114){
var add_fmt = cljs.core.first(arglist__46114);
var add_args = cljs.core.rest(arglist__46114);
return G__46108__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq46008){
...
var G__46011 = cljs.core.first(seq46008__$2);
var seq46008__$3 = cljs.core.next(seq46008__$2);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46009,G__46010,G__46011,seq46008__$3);
}));
...
var seq__46022 = cljs.core.seq(features);
var chunk__46023 = null;
var count__46024 = (0);
var i__46025 = (0);
while(true){
if((i__46025 < count__46024)){
var feature = chunk__46023.cljs$core$IIndexed$_nth$arity$2(null,i__46025);
...
var G__46122 = seq__46022;
var G__46123 = chunk__46023;
var G__46124 = count__46024;
var G__46125 = (i__46025 + (1));
seq__46022 = G__46122;
chunk__46023 = G__46123;
count__46024 = G__46124;
i__46025 = G__46125;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__46022);
if(temp__5753__auto__){
var seq__46022__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__46022__$1)){
var c__4638__auto__ = cljs.core.chunk_first(seq__46022__$1);
var G__46128 = cljs.core.chunk_rest(seq__46022__$1);
var G__46129 = c__4638__auto__;
var G__46130 = cljs.core.count(c__4638__auto__);
var G__46131 = (0);
seq__46022 = G__46128;
chunk__46023 = G__46129;
count__46024 = G__46130;
i__46025 = G__46131;
continue;
} else {
var feature = cljs.core.first(seq__46022__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__46132 = cljs.core.next(seq__46022__$1);
var G__46133 = null;
var G__46134 = (0);
var G__46135 = (0);
seq__46022 = G__46132;
chunk__46023 = G__46133;
count__46024 = G__46134;
i__46025 = G__46135;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o46045 = temp__5751__auto__;
return (o46045["version"]);
} else {
return null;
}
})() == null);
