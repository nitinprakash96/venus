 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__59189){
var vec__59190 = p__59189;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59190,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59190,(1),null);
var ref = vec__59190;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__59202){
var vec__59207 = p__59202;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59207,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59207,(1),null);
var ref = vec__59207;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__59222){
var map__59223 = p__59222;
var map__59223__$1 = cljs.core.__destructure_map(map__59223);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59223__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__59300,entity,state_map,parent_node,idents_seen){
var map__59301 = p__59300;
var map__59301__$1 = cljs.core.__destructure_map(map__59301);
var join_node = map__59301__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59301__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59301__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__59337,entity,state_map,idents_seen){
var map__59341 = p__59337;
var map__59341__$1 = cljs.core.__destructure_map(map__59341);
var join_node = map__59341__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59341__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__59347){
var map__59348 = p__59347;
var map__59348__$1 = cljs.core.__destructure_map(map__59348);
var node = map__59348__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59348__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__59349 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59349,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var e = temp__5751__auto__;
var temp__5751__auto____$1 = (function (){var G__59353 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__59353) : union_key__GT_query.call(null,G__59353));
})();
if(cljs.core.truth_(temp__5751__auto____$1)){
var target_ast_node = temp__5751__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__59368,current_entity,state_map,idents_seen){
var map__59369 = p__59368;
var map__59369__$1 = cljs.core.__destructure_map(map__59369);
var top_node = map__59369__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59369__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59369__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__4210__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__59374 = nil_nodes;
var G__59374__$1 = (((G__59374 == null))?null:cljs.core.first(G__59374));
if((G__59374__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__59374__$1);
}
})());
} else {
return and__4210__auto__;
...
var G__59375 = result_node__$1;
var G__59375__$1 = (((G__59375 == null))?null:cljs.core.persistent_BANG_(G__59375));
if((G__59375__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__59375__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__59381 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__59381 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__59381,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__59389__$1);
}
});
