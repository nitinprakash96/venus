...
var map__59547 = app__$1;
var map__59547__$1 = cljs.core.__destructure_map(map__59547);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59547__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var raf_59564 = (((typeof requestAnimationFrame !== 'undefined'))?requestAnimationFrame:(function (p1__59554_SHARP_){
return com.fulcrologic.fulcro.algorithms.scheduling.defer(p1__59554_SHARP_,(16));
}));
/**
...
var map__59555 = app__$1;
var map__59555__$1 = cljs.core.__destructure_map(map__59555);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59555__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
if(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(runtime_atom),scheduled_key))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(runtime_atom,cljs.core.assoc,scheduled_key,true);
...
return (raf_59564.cljs$core$IFn$_invoke$arity$1 ? raf_59564.cljs$core$IFn$_invoke$arity$1(f) : raf_59564.call(null,f));
}
});
