...
var len__4818__auto___44677 = arguments.length;
var i__4819__auto___44678 = (0);
while(true){
if((i__4819__auto___44678 < len__4818__auto___44677)){
args__4824__auto__.push((arguments[i__4819__auto___44678]));

var G__44679 = (i__4819__auto___44678 + (1));
i__4819__auto___44678 = G__44679;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq44587){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44588,G__44589,seq44587__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__44605_SHARP_){
return (!((cljs.core.meta(p1__44605_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44626__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e44628){var _e__43229__auto__ = e44628;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e44630){var _e__43229__auto__ = e44630;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__44643 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__44644 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__44644);

try{var map__44646 = opts;
var map__44646__$1 = cljs.core.__destructure_map(map__44646);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44646__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__44643);
}});
...
var temp__5751__auto___44706 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___44706)){
var managed_print_level_44708 = temp__5751__auto___44706;
var _STAR_print_level_STAR__orig_val__44658_44709 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__44659_44710 = managed_print_level_44708;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__44659_44710);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__44650_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__44650_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__44658_44709);
}} else {
job_fn();
}
