...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_58028 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_58028(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_58031 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_58031(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_58036 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_58036(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_58040 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_58040(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_58047 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_58047(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_58048 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_58048(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__58026,callback){
var map__58027 = p__58026;
var map__58027__$1 = cljs.core.__destructure_map(map__58027);
var input = map__58027__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58027__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58027__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
