...
var map__44539 = top_item;
var map__44539__$1 = cljs.core.__destructure_map(map__44539);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44539__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44539__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44539__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e44538){var _e = e44538;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___44569 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___44569)){
var seen_errors_44570 = temp__5751__auto___44569;
if(cljs.core.truth_(seen_errors_44570.has(self))){
} else {
seen_errors_44570.add(self);

var temp__5753__auto___44571 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___44571)){
var sense_44573 = temp__5753__auto___44571;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_44573)].join(''));
} else {
}
}
} else {
