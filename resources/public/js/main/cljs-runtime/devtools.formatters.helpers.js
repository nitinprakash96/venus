...
var G__44572 = devtools.prefs.pref(v);
v = G__44572;
continue;
} else {
return v;
...
}catch (e44531){var _e__43229__auto__ = e44531;
return false;
}})();
...
}catch (e44533){var _e__43229__auto__ = e44533;
return false;
}})();
...
}catch (e44535){var _e__43229__auto__ = e44535;
return false;
}}
}
});
...
var vec__44544 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44544,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44544,(1),null);
...
return cljs.core.some((function (p1__44553_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__44553_SHARP_);
}),template);
});
