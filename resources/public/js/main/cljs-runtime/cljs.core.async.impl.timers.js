...
var i_51462 = (0);
while(true){
if((i_51462 < arr.length)){
(arr[i_51462] = null);

var G__51463 = (i_51462 + (1));
i_51462 = G__51463;
continue;
} else {
}
...
var i_51481 = (self__.level + (1));
while(true){
if((i_51481 <= (new_level + (1)))){
(update[i_51481] = self__.header);

var G__51483 = (i_51481 + (1));
i_51481 = G__51483;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_51484 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_51484[i]));
} else {
x__$2.forward.push((((i < links_51484.length))?(links_51484[i]):null));
}

if((i < links_51484.length)){
(links_51484[i] = x__$2);
} else {
links_51484.push(x__$2);
}
...
var i_51494 = (0);
while(true){
if((i_51494 <= self__.level)){
var links_51496 = (update[i_51494]).forward;
if((x__$1 === (((i_51494 < links_51496.length))?(links_51496[i_51494]):null))){
(links_51496[i_51494] = (x__$1.forward[i_51494]));

var G__51499 = (i_51494 + (1));
i_51494 = G__51499;
continue;
} else {
var G__51500 = (i_51494 + (1));
i_51494 = G__51500;
continue;
}
} else {
...
var G__51511 = nx;
var G__51512 = (level__$1 - (1));
x = G__51511;
level__$1 = G__51512;
continue;
} else {
var G__51513 = x;
var G__51514 = (level__$1 - (1));
x = G__51513;
level__$1 = G__51514;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__51519 = nx;
var G__51520 = (level__$1 - (1));
x = G__51519;
level__$1 = G__51520;
continue;
} else {
var G__51521 = x;
var G__51522 = (level__$1 - (1));
x = G__51521;
level__$1 = G__51522;
continue;
}
