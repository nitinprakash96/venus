...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_47669 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_47669(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_47670 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_47670(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47678 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47678(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47682 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47682(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47688 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47688(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47691 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47691(reader);
}
});
...
var G__47754 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__47755 = s.append(c);
c = G__47754;
s = G__47755;
continue;
}
