...
var G__45229 = (i__4819__auto___45227 + (1));
i__4819__auto___45227 = G__45229;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq45109){
var G__45110 = cljs.core.first(seq45109);
var seq45109__$1 = cljs.core.next(seq45109);
var G__45111 = cljs.core.first(seq45109__$1);
var seq45109__$2 = cljs.core.next(seq45109__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45110,G__45111,seq45109__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__45131_SHARP_){
return (!((cljs.core.meta(p1__45131_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45173__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e45174){var _e__43935__auto__ = e45174;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e45180){var _e__43935__auto__ = e45180;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__45190 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__45191 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__45191);

try{var map__45192 = opts;
var map__45192__$1 = cljs.core.__destructure_map(map__45192);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45192__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__45190);
}});
...
var temp__5751__auto___45256 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___45256)){
var managed_print_level_45257 = temp__5751__auto___45256;
var _STAR_print_level_STAR__orig_val__45207_45258 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__45208_45259 = managed_print_level_45257;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__45208_45259);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__45199_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__45199_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__45207_45258);
}} else {
job_fn();
}
