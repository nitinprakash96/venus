...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__56544){
var map__56545 = p__56544;
var map__56545__$1 = cljs.core.__destructure_map(map__56545);
var ast = map__56545__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56545__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56545__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__56546){
var map__56547 = p__56546;
var map__56547__$1 = cljs.core.__destructure_map(map__56547);
var child_ast = map__56547__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56547__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56547__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
...
var G__56548 = idx;
var G__56548__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__56548,dispatch_key,parent_key):G__56548);
var G__56548__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__56548__$1,key,parent_key):G__56548__$1);
var G__56548__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__56548__$2,key,parent_key):G__56548__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__56548__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__56548__$3,child_ast));
} else {
return G__56548__$3;
}
...
var map__56553 = ast;
var map__56553__$1 = cljs.core.__destructure_map(map__56553);
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__56555){
var map__56556 = p__56555;
var map__56556__$1 = cljs.core.__destructure_map(map__56556);
var ast = map__56556__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56556__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56556__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56562__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56562__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__56563 = cljs.core.deref(runtime_atom);
var map__56563__$1 = cljs.core.__destructure_map(map__56563);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56563__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__56578 = com.fulcrologic.fulcro.components.any__GT_app(this$);
var map__56578__$1 = cljs.core.__destructure_map(map__56578);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56578__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var map__56607 = com.fulcrologic.fulcro.components.any__GT_app(this$);
var map__56607__$1 = cljs.core.__destructure_map(map__56607);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56607__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.components.react_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__56628){
var map__56631 = p__56628;
var map__56631__$1 = cljs.core.__destructure_map(map__56631);
var app = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56631__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__56632_56672 = com.fulcrologic.fulcro.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__56633_56673 = true;
(com.fulcrologic.fulcro.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__56633_56673);
...
}finally {(com.fulcrologic.fulcro.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__56632_56672);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__56635 = com.fulcrologic.fulcro.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__56636 = true;
(com.fulcrologic.fulcro.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__56636);
...
}finally {(com.fulcrologic.fulcro.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__56635);
}})], null);
}));
