...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_49585 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_49585(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_49605 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_49605(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_49608 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_49608(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_49609 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_49609(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_49611 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_49611(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_49613 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_49613(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__49581,callback){
var map__49582 = p__49581;
var map__49582__$1 = cljs.core.__destructure_map(map__49582);
var input = map__49582__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49582__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49582__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
