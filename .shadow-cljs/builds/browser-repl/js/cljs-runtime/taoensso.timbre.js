...
var no_stacktrace_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54956__$1,new cljs.core.Keyword(null,"no-stacktrace?","no-stacktrace?",1701072694));
var stacktrace_fonts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54956__$1,new cljs.core.Keyword(null,"stacktrace-fonts","stacktrace-fonts",830799382));
var map__54957 = data;
var map__54957__$1 = cljs.core.__destructure_map(map__54957);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54957__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54957__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var msg_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54957__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54957__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54957__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54957__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54957__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54957__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
return [clojure.string.upper_case(cljs.core.name(level))," ","[",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__4212__auto__ = _QMARK_ns_str;
...
var len__4818__auto___55024 = arguments.length;
var i__4819__auto___55025 = (0);
while(true){
if((i__4819__auto___55025 < len__4818__auto___55024)){
args__4824__auto__.push((arguments[i__4819__auto___55025]));

var G__55026 = (i__4819__auto___55025 + (1));
i__4819__auto___55025 = G__55026;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq54959){
var G__54960 = cljs.core.first(seq54959);
var seq54959__$1 = cljs.core.next(seq54959);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54960,seq54959__$1);
}));
...
var or__4212__auto__ = (taoensso.timbre._levels_set.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_set.cljs$core$IFn$_invoke$arity$1(x) : taoensso.timbre._levels_set.call(null,x));
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
...
return ((function (){var G__54962 = taoensso.timbre.valid_level(x);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__54962) : taoensso.timbre._levels_map.call(null,G__54962));
})() >= (function (){var G__54963 = taoensso.timbre.valid_level(y);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__54963) : taoensso.timbre._levels_map.call(null,G__54963));
})());
});
...
var fexpr__54964 = taoensso.timbre._compile_ns_filter(whitelist,blacklist);
return (fexpr__54964.cljs$core$IFn$_invoke$arity$1 ? fexpr__54964.cljs$core$IFn$_invoke$arity$1(_QMARK_ns) : fexpr__54964.call(null,_QMARK_ns));
}));
/**
...
var vec__54970 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54970,(0),null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__54973 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54973,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__54976 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54976,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(fmt_msg_QMARK_)?taoensso.timbre.vrest(vargs__$1):vargs__$1);
...
var instant_55074 = taoensso.encore.now_dt();
var context_55075 = taoensso.timbre._STAR_context_STAR_;
var vargs_55076 = cljs.core.deref(vargs_);
var vec__54983_55077 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_55076);
var _QMARK_err_55078__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54983_55077,(0),null);
var _QMARK_meta_55079 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54983_55077,(1),null);
var _QMARK_msg_fmt_55080 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54983_55077,(2),null);
var vargs_55081__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54983_55077,(3),null);
var data_55082 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4212__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?err_","?err_",789480858),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891)],[instant_55074,config,vargs_55081__$1,_QMARK_file,(function (){var fexpr__54987 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null);
return (fexpr__54987.cljs$core$IFn$_invoke$arity$1 ? fexpr__54987.cljs$core$IFn$_invoke$arity$1(level) : fexpr__54987.call(null,level));
})(),_QMARK_ns_str,level,_QMARK_err_55078__$1,context_55075,_QMARK_line,(new cljs.core.Delay((function (){
return _QMARK_err_55078__$1;
}),null)),_QMARK_meta_55079,_QMARK_msg_fmt_55080]));
var _QMARK_data_55083 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_55082,new cljs.core.Keyword(null,"middleware","middleware",1462115504).cljs$core$IFn$_invoke$arity$1(config));
var temp__5753__auto___55090 = _QMARK_data_55083;
if(cljs.core.truth_(temp__5753__auto___55090)){
var data_55091__$1 = temp__5753__auto___55090;
var map__54988_55093 = data_55091__$1;
var map__54988_55094__$1 = cljs.core.__destructure_map(map__54988_55093);
var vargs_55095__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54988_55094__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_55096__$2 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_55091__$1,new cljs.core.Keyword(null,"vargs_","vargs_",552132148),(new cljs.core.Delay((function (){
return vargs_55095__$2;
}),null)));
var data_55097__$3 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_55096__$2,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
var G__54990 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__54990)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__54990)){
return taoensso.timbre.str_join(vargs_55095__$2);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__54990)){
if(typeof _QMARK_msg_fmt_55080 === 'string'){
} else {
...
return taoensso.encore.format_STAR_(_QMARK_msg_fmt_55080,vargs_55095__$2);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__54990)].join('')));
...
return cljs.core.hash(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [callsite_id,_QMARK_msg_fmt_55080,cljs.core.get.cljs$core$IFn$_invoke$arity$3(_QMARK_meta_55079,new cljs.core.Keyword(null,"hash","hash",-13781596),vargs_55095__$2)], null));
}),null))], 0));
var output_fn1_55098 = taoensso.encore.memoize_(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
if(cljs.core.truth_(and__4210__auto__)){
return taoensso.timbre.level_GT__EQ_(level,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"min-level","min-level",1634684919).cljs$core$IFn$_invoke$arity$1(appender);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
...
return cljs.core.not((function (){var G__54995 = cljs.core.force(new cljs.core.Keyword(null,"hash_","hash_",-827203612).cljs$core$IFn$_invoke$arity$1(data_55097__$3));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__54995) : rl_fn.call(null,G__54995));
})());
}
})();
if(rate_limit_okay_QMARK_){
var map__54997 = appender;
var map__54997__$1 = cljs.core.__destructure_map(map__54997);
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54997__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54997__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
...
var args__4824__auto__ = [];
var len__4818__auto___55118 = arguments.length;
var i__4819__auto___55119 = (0);
while(true){
if((i__4819__auto___55119 < len__4818__auto___55118)){
args__4824__auto__.push((arguments[i__4819__auto___55119]));

var G__55122 = (i__4819__auto___55119 + (1));
i__4819__auto___55119 = G__55122;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq55007){
var self__4806__auto__ = this;
return self__4806__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55007));
}));
