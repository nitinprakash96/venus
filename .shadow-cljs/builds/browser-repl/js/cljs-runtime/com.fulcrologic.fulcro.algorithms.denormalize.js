 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__55035){
var vec__55036 = p__55035;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55036,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55036,(1),null);
var ref = vec__55036;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__55039){
var vec__55040 = p__55039;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55040,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55040,(1),null);
var ref = vec__55040;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__55053){
var map__55054 = p__55053;
var map__55054__$1 = cljs.core.__destructure_map(map__55054);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55054__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
var temp__5751__auto__ = (function (){var and__4210__auto__ = cljs.core.coll_QMARK_(entity);
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__55072,entity,state_map,parent_node,idents_seen){
var map__55073 = p__55072;
var map__55073__$1 = cljs.core.__destructure_map(map__55073);
var join_node = map__55073__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55073__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
...
if(cljs.core.truth_((function (){var and__4210__auto__ = recursive_QMARK_;
if(and__4210__auto__){
return join_entity;
} else {
return and__4210__auto__;
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__55124,entity,state_map,idents_seen){
var map__55126 = p__55124;
var map__55126__$1 = cljs.core.__destructure_map(map__55126);
var join_node = map__55126__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55126__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__55128){
var map__55129 = p__55128;
var map__55129__$1 = cljs.core.__destructure_map(map__55129);
var node = map__55129__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55129__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var temp__5751__auto__ = (function (){var and__4210__auto__ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(lookup_ref);
if(and__4210__auto__){
...
var vec__55140 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55140,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var e = temp__5751__auto__;
var temp__5751__auto____$1 = (function (){var G__55144 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__55144) : union_key__GT_query.call(null,G__55144));
})();
if(cljs.core.truth_(temp__5751__auto____$1)){
var target_ast_node = temp__5751__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__55150,current_entity,state_map,idents_seen){
var map__55151 = p__55150;
var map__55151__$1 = cljs.core.__destructure_map(map__55151);
var top_node = map__55151__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55151__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55151__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
var wildcard_QMARK_ = (function (){var and__4210__auto__ = nil_nodes;
if(cljs.core.truth_(and__4210__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__55154 = nil_nodes;
var G__55154__$1 = (((G__55154 == null))?null:cljs.core.first(G__55154));
if((G__55154__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__55154__$1);
}
})());
} else {
return and__4210__auto__;
...
var G__55155 = result_node__$1;
var G__55155__$1 = (((G__55155 == null))?null:cljs.core.persistent_BANG_(G__55155));
if((G__55155__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__55155__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__55158 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__55158 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__55158,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__55162 = props;
var G__55162__$1 = (((G__55162 == null))?null:cljs.core.meta(G__55162));
if((G__55162__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__55162__$1);
}
});
